...
export default class Joypad extends JoypadEventEmitter {
    ...
    vibrate(parameters) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const parsedParams = Object.assign({ startDelay: 0, duration: 1000, weakMagnitude: 1, strongMagnitude: 1 }, parameters);
            return (_b = (_a = this.nativePad) === null || _a === void 0 ? void 0 : _a.vibrationActuator) === null || _b === void 0 ? void 0 : _b.playEffect('dual-rumble', parsedParams);
        });
    }
    stopVibrate() {
        var _a, _b;
